...
All flows use OAuth 2.0 (Client Credentials) stored securely in Web Connect. Token management is documented in the customer repo.

---

## Related

[Web Connect Integrations](../README.md) · [API Reference](https://api-docs.virtualstock.com) · [How-to](../../../../how-to/web-connect/README.md)
